              ...
              <FAQItem key={index}>
                <FAQQuestion onClick={() => toggleFAQ(index)}>
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    <IconQuestion style={{ marginRight: '0.5em' }} />
                    {faq.question}
                  </div>
                  <ChevronIcon>
